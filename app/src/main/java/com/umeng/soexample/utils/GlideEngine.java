...
public class GlideEngine implements ImageEngine {
    ...
    public void loadFolderImage(@NonNull final Context context, @NonNull String url, @NonNull final ImageView imageView) {
        Glide.with( context )
                ...
                .apply( new RequestOptions().placeholder( R.drawable.picture_image_placeholder ).override( 180, 180 )
                        .centerCrop()
                        .sizeMultiplier( 0.5f ) )
    ...
    public void loadGridImage(@NonNull Context context, @NonNull String url, @NonNull ImageView imageView) {
        Glide.with( context )
                ...
                .apply( new RequestOptions().placeholder( R.drawable.picture_image_placeholder ).override( 200, 200 )
                        .centerCrop() )
                .into( imageView );
    }
